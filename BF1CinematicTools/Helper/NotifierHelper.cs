...
public static class NotifierHelper
{
    ...
    static NotifierHelper()
    {
        ...
        NotificationConstants.InformationBackgroundColor = (Brush)new BrushConverter().ConvertFrom("#2080F0");
        NotificationConstants.SuccessBackgroundColor = (Brush)new BrushConverter().ConvertFrom("#18A058");
        NotificationConstants.WarningBackgroundColor = (Brush)new BrushConverter().ConvertFrom("#F0A020");
        NotificationConstants.ErrorBackgroundColor = (Brush)new BrushConverter().ConvertFrom("#D03050");
    }
