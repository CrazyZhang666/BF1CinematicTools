using BF1CinematicTools.Api;
using BF1CinematicTools.Core;
using BF1CinematicTools.Helper;
using BF1CinematicTools.Models;
...
public partial class MainWindow
{
    ...
    private void Window_Main_Closing(object sender, CancelEventArgs e)
    {
        ...
        if (!_isCodeClose)
        {
            ...
            if (!_isFirstNotice)
            {
                NotifyIcon_Main.ShowBalloonTip("战地1电影工具箱 已最小化到托盘", "可通过托盘右键菜单完全退出程序", BalloonIcon.Info);
                _isFirstNotice = true;
            }
